...
!      3. Date (YYYYMMDD)
!      4. Latitude parameters
!      5. Longitude parameters
!      6. Start hour
!      7. End hour
!      8. Output format
      ...
      if (nargs .lt. 3) then
	    write(6,*) 'cmorph2nc: Incomplete command-line argument list (infile, outfile, and date required).'
		call exit()        
      endif
...
! Write subset data        
        ...
        if (format .eq. 'BINARY') then
          ...
          call cmorph_write_var('mmw_precip', timeOUT, mwOUT, time_start, val_start)
